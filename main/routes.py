...
from models import ContactMessage, ContactInquiry, Event
...
def contact():
    if request.method == 'POST':
        ...
        # Get IP address and source page
        ip_address = request.environ.get('HTTP_X_FORWARDED_FOR', request.remote_addr)
        source_page = request.referrer or 'direct'

        # Save to old ContactMessage table (for backward compatibility)
        ...
        # Save to new ContactInquiry table for tracking
        new_inquiry = ContactInquiry(
            name=name,
            email=email,
            inquiry_type=subject.lower(),
            message=message,
